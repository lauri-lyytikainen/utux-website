    ...
    <>
      <section>
        <div className="relative mx-auto">
          ...
          />
          <div className="absolute top-0 left-0 w-full h-full bg-white/50 flex items-center justify-center text-black">
            <p className="font-thin text-2xl text-center">
              UI on Ulkomuoto
              <br />
              <p className="font-normal text-4xl inline">UX</p> on kokemus
            </p>
          </div>
        </div>
      </section>
